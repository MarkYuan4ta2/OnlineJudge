...
@section('content')
    <div class="container main">
        ...
        <h2 class="text-center">{{$contest->name}}&nbsp;:&nbsp;{{$problem->title}}</h2>
        ...
        @elseif($contest->state != 'other')
            <div class="alert alert-warning" role="alert">
                <p>不在比赛时间，无法提交代码</p>
            </div>
        @else
            <div class="alert alert-warning" role="alert">
                <p>比赛可能出现了一些状况，请联系比赛老师<a href="mailto:{{$teacher->email}}">{{$teacher->name}}</a>，或稍后再来参赛</p>
            </div>
        @endif
